...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MediaResponse&&(identical(other.url, url) || other.url == url));
}
...
class _MediaResponse implements MediaResponse {
  const _MediaResponse({required this.url});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MediaResponse&&(identical(other.url, url) || other.url == url));
}
